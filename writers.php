            ...
            <div class="wrapper">
                <div class="banner__wrapper">
                    <div class="header__title ">
                        <h1 class="main__header-h1 " style="color: black; margin-bottom: 50px;">Писатели</h1>
                        ...
                        <table class="table">
                            ...
                            $query = $pdo -> query('SELECT * FROM `writers`');
                            while($row = $query -> fetch(PDO::FETCH_OBJ)){
                                ...
                                <tr>
                                    ...
                                    <td>' . $row-> img . '</td>
                                    <td>'. substr($row->text, 0, 140) . '...</td>
                                    <td><a>Удалить 22</a></td>                           
                                <tr>';                      
                            }
                        ...
                        <form class="form" action="/writers-run.php" method="post" class="">
